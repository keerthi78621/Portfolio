...
const Hero = () => {
  ...
  const titles = ['Associate Software Developer', 'Java Full Stack Developer', 'AI & Data Science Enthusiast'];
      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <h2 className="hero-subtitle">
            Associate Software Developer | <span className="animated-text">{titles[textIndex]}</span>
          </h2>
