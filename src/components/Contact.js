      ...
      <div className="contact-container">
        <div className="contact-info">
          ...
          <p className="contact-text">
            I'm always interested in learning, building and connecting with people working in 
            software development, full-stack engineering and AI/data-driven technologies.
          </p>
          ...
          <div className="social-links contact-social">
            ...
            <a href="https://leetcode.com/u/mp73j9Jua1/" target="_blank" rel="noopener noreferrer" className="social-icon">
              <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <form className="contact-form" action="mailto:Keerthi21056@gmail.com" method="post" encType="text/plain">
